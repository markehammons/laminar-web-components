...
val componentCollection = WebComponentCollection(
  ...
  components = Seq(
    WebComponent(
      ...
      npmPackage =
        NpmPackage(name = "@material/mwc-button", version = V.material),
      ...
      cssProperties = Seq(
        ...
        CSSProperty(
          name = "--mdc-theme-on-primary",
          description = "Text color of a raised button."
        )
      )
    ),
    WebComponent(
      ...
      link =
        "https://github.com/material-components/material-components-web-components/tree/master/packages/checkbox",
      npmPackage =
        NpmPackage(name = "@material/mwc-checkbox", version = V.material),
    ...
    WebComponent(
      ...
      link =
        "https://github.com/material-components/material-components-web-components/tree/master/packages/dialog",
      npmPackage =
        NpmPackage(name = "@material/mwc-dialog", version = V.material),
    ...
    WebComponent(
      ...
      link =
        "https://github.com/material-components/material-components-web-components/tree/master/packages/drawer",
      npmPackage =
        NpmPackage(name = "@material/mwc-drawer", version = V.material),
    ...
    WebComponent(
      ...
      link =
        "https://github.com/material-components/material-components-web-components/tree/master/packages/fab",
      npmPackage = NpmPackage(name = "@material/mwc-fab", version = V.material),
    ...
    WebComponent(
      ...
      npmPackage =
        NpmPackage(name = "@material/mwc-formfield", version = V.material),
    ...
    WebComponent(
      ...
      npmPackage =
        NpmPackage(name = "@material/mwc-icon-button", version = V.material),
    ...
    WebComponent(
      ...
      npmPackage =
        NpmPackage(name = "@material/mwc-icon", version = V.material),
    ...
    WebComponent(
      ...
      link =
        "https://github.com/material-components/material-components-web-components/tree/master/packages/radio",
      npmPackage =
        NpmPackage(name = "@material/mwc-radio", version = V.material),
    ...
    WebComponent(
      ...
      npmPackage =
        NpmPackage(name = "@material/mwc-slider", version = V.material),
    ...
    WebComponent(
      ...
      link =
        "https://github.com/material-components/material-components-web-components/tree/master/packages/snackbar",
      npmPackage =
        NpmPackage(name = "@material/mwc-snackbar", version = V.material),
    ...
    WebComponent(
      ...
      link =
        "https://github.com/material-components/material-components-web-components/tree/master/packages/switch",
      npmPackage =
        NpmPackage(name = "@material/mwc-switch", version = V.material),
    ...
    WebComponent(
      ...
      npmPackage =
        NpmPackage(name = "@material/mwc-tab-bar", version = V.material),
      jsImport = "@material/mwc-tab-bar",
      slots = Slots(
        default =
          Some(DefaultSlot(description = "mwc-tab elements to display.")),
        named = Seq(
        )
      ),
      properties = Seq(
      ...
      subComponents = Seq(
        WebComponent(
          ...
          description =
            "Tabs organize content across different screens, data sets, and other interactions.",
          link =
            "https://github.com/material-components/material-components-web-components/tree/master/packages/tab",
          npmPackage =
            NpmPackage(name = "@material/mwc-tab", version = V.material),
          ...
          methods = Seq(
            ...
            Method(
              name = "deactivate",
              description = "Deactivates the indicator."
            ),
            Method(
              name = "computeDimensions()",
              description = "Computes the dimensions of the content."
            ),
            Method(
              name = "computeIndicatorClientRect",
              description = "Computes the dimensions of the indicator."
            )
          ),
          events = Seq(
            Event(
          ...
          cssProperties = Seq(
            ...
            CSSProperty(
              name = "--mdc-tab-stacked-height",
              description = "Height of the tab's stacked variant."
            ),
            CSSProperty(
            ...
            CSSProperty(
              ...
              description = "Color of an unactivated icon."
            )
          )
        )
      )
    ...
    WebComponent(
      ...
      link =
        "https://github.com/material-components/material-components-web-components/tree/master/packages/tab-bar",
      npmPackage =
        NpmPackage(name = "@material/mwc-list", version = V.material),
      ...
      methods = Seq(
        Method(
          name = "select",
          description = "Selects the elements at the given index / indices."
        ),
        Method(
          name = "toggle",
          description =
      ...
      subComponents = Seq(
        WebComponent(
          ...
          link =
            "https://github.com/material-components/material-components-web-components/tree/master/packages/list",
          npmPackage =
            NpmPackage(name = "@material/mwc-list", version = V.material),
    ...
    WebComponent(
      ...
      link =
        "https://github.com/material-components/material-components-web-components/tree/master/packages/menu",
      npmPackage =
        NpmPackage(name = "@material/mwc-menu", version = V.material),
      ...
      cssProperties = Seq(
        ...
        CSSProperty(
          name = "--mdc-menu-item-height",
          description = "Height of single-line list-items in the menu."
        ),
        CSSProperty(
          name = "--mdc-menu-min-width",
          description = "Menu min-width."
        ),
        CSSProperty(
          name = "--mdc-menu-max-width",
          description = "Menu max-width."
        ),
        CSSProperty(
          name = "--mdc-menu-max-height",
          description = "Menu max height."
        ),
        CSSProperty(
          name = "--mdc-menu-z-index",
          description = "Z-index of the popup menu surface."
        ),
        CSSProperty(
          name = "--mdc-theme-surface",
          description = "Color of the menu surface."
        )
      )
    ),
    WebComponent(
      ...
      npmPackage =
        NpmPackage(name = "@material/mwc-textfield", version = V.material),
      ...
      methods = Seq(
        ...
        Method(
          name = "select",
          description = "Selects the element at the given index."
        ),
        Method(
          name = "layout",
          description =
    ...
    WebComponent(
      ...
      link =
        "https://github.com/material-components/material-components-web-components/tree/master/packages/textarea",
      npmPackage =
        NpmPackage(name = "@material/mwc-textarea", version = V.material),
      jsImport = "@material/mwc-textarea",
      properties = Seq(
        Property(
          name = "rows",
          tpe = WebComponentFieldType.Number,
          description = "Sets number of visible text lines."
        ),
        Property(
          name = "cols",
          tpe = WebComponentFieldType.Number,
    ...
    WebComponent(
      ...
      link =
        "https://github.com/material-components/material-components-web-components/tree/master/packages/select",
      npmPackage =
        NpmPackage(name = "@material/mwc-select", version = V.material),
      ...
      properties = Seq(
        ...
        Property(
          name = "selected",
          tpe = WebComponentFieldType.Any,
          description = "Selected list item element."
        ),
        Property(
          name = "items",
          tpe = WebComponentFieldType.Any,
        ...
        Property(
          name = "index",
          tpe = WebComponentFieldType.Number,
          description = "Index of selected list item."
        ),
        Property(
          name = "validity",
          tpe = WebComponentFieldType.Any,
      ...
      cssProperties = Seq(
        CSSProperty(
          name = "--mdc-select-error-color",
          description = "Applies where --mdc-theme-error applies."
        ),
        CSSProperty(
    ...
    WebComponent(
      ...
      npmPackage =
        NpmPackage(name = "@material/mwc-top-app-bar", version = V.material),
